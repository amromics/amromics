...
def pan_genome_analysis(samples, work_dir, collection_id, collection_name=None, progressive=False,overwrite=False, threads=0, memory=8, timing_log=None,method='roary',  genetree=True):
    ...
    report = wrapper.run_collection(report,gff_dir,ffn_dir,overwrite=overwrite,base_dir=collection_dir,progressive=progressive, threads=threads,timing_log=timing_log,method=method, genetree=genetree)
